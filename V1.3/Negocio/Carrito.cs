class Carrito
{
    ...
    public void setDescuento(double descuento) { descuentoAplicado = descuento; }
    public double getDescuento() { return descuentoAplicado; }
    public double getTotalConDescuento() { return getTotal() - descuentoAplicado; }
}